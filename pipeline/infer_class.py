...
# ============ Step 3: 推理流程 ============
def inference_on_images(model, image_paths, save_txt_path=None, save_l3_dir="",target=2):
...
if __name__ == "__main__":
    ...
    results = inference_on_images(model, image_paths, save_txt_path=save_txt_path)
